...
/**
 * This class represents a response generated after a flexible locate image request
...
@NoArgsConstructor
@AllArgsConstructor
public class FlexibleLocateImageResponse {
  private String id;
  ...
  private FlexLocateDetails flexLocate;
}