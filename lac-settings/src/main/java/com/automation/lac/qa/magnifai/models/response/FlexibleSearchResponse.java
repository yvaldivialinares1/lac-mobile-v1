...
/**
 * This class represents a response generated after a flexible search image request
...
@NoArgsConstructor
@AllArgsConstructor
public class FlexibleSearchResponse {
  private String id;
  ...
  private FlexSearchDetails flexSearch;
}
